...
const geoserverUrl = config.public.geoserverBaseUrl
const geonodeAdminUrl = `${config.public.geonodeBaseUrl}${config.public.geonodeForceScriptName}${config.public.geonodeAdminPath}`

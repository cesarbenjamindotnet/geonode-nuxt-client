...
csw = <span class="class-name">CatalogueServiceWeb</span>(<span class="string">'{{config.public.geonodeBaseUrl}}/catalogue/csw'</span>)
...
let geonodeLayer = new <span class="class-name">OpenLayers.Layer.WMS</span>(
    ...
    <span class="string">"{{config.public.geonodeBaseUrl}}/geoserver/wms"</span>,
    {layers: <span class="string">"risk:nicaragua_admin"</span>}
        ...
        <pre class="custom-code">
<code>
const tileUrl = <span class="string">"{{config.public.geonodeBaseUrl}}/geoserver/gwc/service/gmaps?layers=risk:nicaragua_admin&zoom={Z}&x={X}&y={Y}"</span>;
let tilelayer = new <span class="class-name">GTileLayer</span>(null, null, null, {tileUrlTemplate: tileUrl});</code>
        ...
        <p><code class="bg-grey-4 q-px-xs">{{config.public.geonodeBaseUrl}}/geoserver/wfs?request=GetFeature&typeName=risk:nicaragua_admin&outputformat=SHAPE-ZIP</code></p>

...
csw = <span class="class-name">CatalogueServiceWeb</span>(<span class="string">'https://stable.demo.geonode.org/catalogue/csw'</span>)
...
let geonodeLayer = new <span class="class-name">OpenLayers.Layer.WMS</span>(
    ...
    <span class="string">"http://demo.geonode.org/geoserver/wms"</span>,
    {layers: <span class="string">"risk:nicaragua_admin"</span>}
        ...
        <pre class="custom-code">
<code>
const tileUrl = <span class="string">"http://demo.geonode.org/geoserver/gwc/service/gmaps?layers=risk:nicaragua_admin&zoom={Z}&x={X}&y={Y}"</span>;
let tilelayer = new <span class="class-name">GTileLayer</span>(null, null, null, {tileUrlTemplate: tileUrl});</code>
        ...
        <p><code class="bg-grey-4 q-px-xs">http://demo.geonode.org/geoserver/wfs?request=GetFeature&typeName=risk:nicaragua_admin&outputformat=SHAPE-ZIP</code></p>
